package idv.hsiehpinghan.beanutility.object;
...
public class Inner {
	...
	public Inner(byte _byte, short _short, int _int, long _long, float _float,
	...
	public String toString() {
		return "Inner [_byte=" + _byte + ", _short=" + _short + ", _int="
				+ _int + ", _long=" + _long + ", _float=" + _float
				+ ", _double=" + _double + ", _char=" + _char + ", _boolean="
				+ _boolean + ", _Object=" + _Object + "]";
	}
