...
import idv.hsiehpinghan.beanutility.object.Inner;
import idv.hsiehpinghan.beanutility.object.Outer;
import idv.hsiehpinghan.beanutility.suit.TestngSuitSetting;
...
public class BeanUtilityTest {
	...
	private void setBeans() {
		...
		beanUtility = applicationContext.getBean(BeanUtility.class);
	}
